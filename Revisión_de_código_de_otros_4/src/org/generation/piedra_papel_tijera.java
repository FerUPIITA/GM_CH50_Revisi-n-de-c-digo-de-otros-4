...
public class piedra_papel_tijera {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		    ...
		    if(j2.equals("piedra") || j2.equals("papel") || j2.equals("tijeras")) {//Se agregó la sentencia para que j2 escriba bien la opcion
		      int g = 2;
		      switch(j1) {
		        case "piedra":
		        ...
		        case "tijeras":
		          ...
		          break;
		        default:
		        	System.out.println("No está esa opción, elija piedra, papel o tijeras Jugador 1"); // Se definio mensaje de 
		      ...
		      System.out.println("Gana el jugador " + g);
		        	...
		        	System.out.println("No está esa opción, elija piedra, papel o tijeras Jugador 2"); // Se definio mensaje de 
